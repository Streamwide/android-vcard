 ...
 * @version $Id$
 */
public class QuotedPrintableCodec implements BinaryDecoder, StringEncoder, StringDecoder {
    /**
     ...
     * @since 1.7
     */
    public QuotedPrintableCodec(@NonNull final Charset charset) {
        this(charset, false);
    }
     ...
     * @since 1.10
     */
    public QuotedPrintableCodec(@NonNull final Charset charset, final boolean strict) {
     ...
     */
    public static final @Nullable byte[] encodeQuotedPrintable(@Nullable final BitSet printable, @Nullable final byte[] bytes) {
     ...
     * @since 1.10
     */
    public static final @Nullable byte[] encodeQuotedPrintable(@Nullable BitSet printable, @Nullable final byte[] bytes, final boolean strict) {
        if (bytes == null) {
            return null;
        }
        if (printable == null) {
     ...
     */
    public static final @Nullable byte[] decodeQuotedPrintable(@Nullable final byte[] bytes) throws DecoderException {
        if (bytes == null) {
            return null;
        }
        final ByteArrayOutputStream buffer = new ByteArrayOutputStream();
     ...
     * @return array of bytes containing quoted-printable data
     */
    public @Nullable byte[] encode(@Nullable final byte[] bytes) {
    ...
    @Override
    @Nullable
    public byte[] decode(@Nullable final byte[] bytes) throws DecoderException {
    ...
    @Override
    @Nullable
    public String encode(@Nullable final String sourceStr) throws EncoderException {
        return this.encode(sourceStr, this.charset);
    }
     ...
     * @since 1.7
     */
    public @Nullable String decode(@Nullable final String sourceStr, @NonNull final Charset sourceCharset) throws DecoderException {
        if (sourceStr == null) {
            return null;
        }
     ...
     */
    public @Nullable String decode(@Nullable final String sourceStr, @NonNull final String sourceCharset) throws DecoderException, UnsupportedEncodingException {
        if (sourceStr == null) {
            return null;
        }
    ...
    @Override
    @Nullable
    public String decode(@Nullable final String sourceStr) throws DecoderException {
        return this.decode(sourceStr, this.charset);
    }
    ...
    @Override
    @Nullable
    public Object encode(@Nullable final Object obj) throws EncoderException {
        if (obj == null) {
            return null;
    ...
    @Override
    @Nullable
    public Object decode(final @Nullable Object obj) throws DecoderException {
        if (obj == null) {
            return null;
        } else if (obj instanceof byte[]) {
     ...
     * @return the default Charset name
     */
    public @Nullable String getDefaultCharset() {
     ...
     */
    @Nullable
    public String encode(@Nullable final String sourceStr, @NonNull final Charset sourceCharset) {
        if (sourceStr == null) {
            return null;
        }
     ...
     */
    public @Nullable String encode(@Nullable final String sourceStr, @NonNull final String sourceCharset) throws UnsupportedEncodingException {
        if (sourceStr == null) {
            return null;
        }
